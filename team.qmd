...
Philippe Schwaller joined EPFL in February 2022 and leads the Laboratory of Artificial Chemical Intelligence.
LIAC develops artificial intelligence for chemical reasoning, synthesis planning, molecular and materials discovery, and experimental optimization.
Philippe is also a core PI of NCCR Catalysis and NCCR Separations.
...
<div class="center">
[{{< fa envelope size=2xl >}}](mailto:philippe.schwaller@epfl.ch) ---
[{{< fa brands twitter size=2xl >}}](https://twitter.com/pschwllr) ---
[{{< fa brands github size=2xl >}}](https://github.com/pschwllr) ---
[{{< fa graduation-cap size=2xl >}}](https://scholar.google.com/citations?user=Tz0I4ywAAAAJ)
</div>
:::
:::
:::
...
The amazing person who makes sure that everything runs smoothly -- [{{< fa envelope >}}](https://mailhide.io/e/3FagEfKd)
:::
:::
:::
...
::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/MattHart.jpeg){.img-fluid .img-round}
...
- Since September 2025
- Based in Singapore, CARES SM3 project
:::
:::

::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/MaartenDobbelaere.jpeg){.img-fluid .img-round}
...
::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/TomFroembgen.jpg){.img-fluid .img-round}
...
::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/GianinThomann.jpg){.img-fluid .img-round}
...
::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/RemiSchlama.jpg){.img-fluid .img-round}
...
::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/DavidMingSegura.png){.img-fluid .img-round}
...
::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/SaumyaThakur.jpg){.img-fluid .img-round}
...
::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/ThibaudSouthiratn.jpeg){.img-fluid .img-round}
...
::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/GabrielGibberd.jpeg){.img-fluid .img-round}
...
::: {.g-col-12 .g-col-sm-6 .g-col-md-4}
::: {.callout-note appearance="simple" icon=false}
![](images/AnabelYong.png){.img-fluid .img-round}
...
<!-- TODO: confirm with Jeremy whether to re-add "BSc and MSc from EPFL" -->
<!-- - BSc and MSc from EPFL -->
:::
:::
:::

<!-- Visiting Postdoctoral Researchers section commented out: currently no one in this category -->
...
- Since September 2026
- From Vall d'Hebron Institute of Oncology (VHIO)
:::
:::
:::
